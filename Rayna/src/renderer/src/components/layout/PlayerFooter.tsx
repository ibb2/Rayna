...
import { Play, SkipBack, SkipForward, Shuffle, Repeat, Mic2, ListMusic, Laptop2, Volume2 } from "lucide-react"
        ...
        <div className="h-24 bg-card border-t border-border flex items-center justify-between px-4 fixed bottom-0 w-full z-50">
            ...
            <div className="flex items-center gap-4 w-[30%]">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground hover:underline cursor-pointer">Artist Name</span>
                </div>
            </div>
